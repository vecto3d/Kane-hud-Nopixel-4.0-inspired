...
function restartHud() {
  closeMenu();
  $.post("https://" + resourceName + "/restartHud");
}
function resetStorage() {
  closeMenu();
  $.post("https://" + resourceName + "/resetStorage");
}
function showOutMap() {
  $.post("https://" + resourceName + "/showOutMap");
}
function showOutCompass() {
  $.post("https://" + resourceName + "/showOutCompass");
}
function showFollowCompass() {
  $.post("https://" + resourceName + "/showFollowCompass");
}
function openMenuSounds() {
  $.post("https://" + resourceName + "/openMenuSounds");
}
function resetHudSounds() {
  $.post("https://" + resourceName + "/resetHudSounds");
}
function checklistSounds() {
  $.post("https://" + resourceName + "/checklistSounds");
}
function showMapNotif() {
  $.post("https://" + resourceName + "/showMapNotif");
}
function showFuelAlert() {
  $.post("https://" + resourceName + "/showFuelAlert");
}
function showCinematicNotif() {
  $.post("https://" + resourceName + "/showCinematicNotif");
}
function dynamicHealth() {
  $.post("https://" + resourceName + "/dynamicHealth");
}
function dynamicArmor() {
  $.post("https://" + resourceName + "/dynamicArmor");
}
function dynamicHunger() {
  $.post("https://" + resourceName + "/dynamicHunger");
}
function dynamicThirst() {
  $.post("https://" + resourceName + "/dynamicThirst");
}
function dynamicStress() {
  $.post("https://" + resourceName + "/dynamicStress");
}
function dynamicOxygen() {
  $.post("https://" + resourceName + "/dynamicOxygen");
}
function dynamicEngine() {
  $.post("https://" + resourceName + "/dynamicEngine");
}
function dynamicNitro() {
  $.post("https://" + resourceName + "/dynamicNitro");
}
function ToggleMapShape() {
  $.post("https://" + resourceName + "/ToggleMapShape");
}
function changeFPS() {
  $.post("https://" + resourceName + "/changeFPS");
}
function ToggleMapBorders() {
  $.post("https://" + resourceName + "/ToggleMapBorders");
}
function HideMap() {
  $.post("https://" + resourceName + "/HideMap");
}
function changeCompassFPS() {
  $.post("https://" + resourceName + "/changeCompassFPS");
}
function showCompassBase() {
  $.post("https://" + resourceName + "/showCompassBase");
}
function showStreetsNames() {
  $.post("https://" + resourceName + "/showStreetsNames");
}
function showPointerIndex() {
  $.post("https://" + resourceName + "/showPointerIndex");
}
function showDegreesNum() {
  $.post("https://" + resourceName + "/showDegreesNum");
}
function cinematicMode() {
  $.post("https://" + resourceName + "/cinematicMode");
}
